...
def main(stdscr):
    ...
    decompress_files()
    file_exist = os.path.exists('students.pickle') and os.path.exists('courses.pickle') and os.path.exists('marks.pickle')
    ...
    if os.path.exists('students.pickle') and os.path.exists('courses.pickle') and os.path.exists('marks.pickle'):
        compress_files()
